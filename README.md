...
- **1273 passing tests**: `cargo test --lib` — 0 failures
...
cargo test --lib         # Run library tests (1273 passing)
...
| Test coverage | 1273 passing, 0 failed, 1 ignored (`cargo test --lib`, evidence: atlas/TEST_COUNTS.json) |
