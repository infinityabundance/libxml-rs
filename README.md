...
Latest gates: `cargo test --lib` 1314 passed / 0 failed (3 ignored); PHP six-extension
...
- **1314 passing tests**: `cargo test --lib` — 0 failures
...
cargo test --lib         # Run library tests (1314 passing)
...
| Test coverage | 1314 passing, 0 failed, 3 ignored (`cargo test --lib`, evidence: atlas/TEST_COUNTS.json) |
