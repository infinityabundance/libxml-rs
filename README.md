...
- **1146 passing tests**: `cargo test --lib` — 0 failures
...
cargo test --lib                     # Run library tests (1146 passing)
...
| Test coverage | 1146 passing, 0 failed, 1 ignored (`cargo test --lib`, evidence: atlas/TEST_COUNTS.json) |
