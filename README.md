...
- **1301 passing tests**: `cargo test --lib` — 0 failures
...
cargo test --lib         # Run library tests (1301 passing)
...
| Test coverage | 1301 passing, 0 failed, 1 ignored (`cargo test --lib`, evidence: atlas/TEST_COUNTS.json) |
