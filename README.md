...
Latest gates: `cargo test --lib` 1281 passed / 0 failed; PHP six-extension
...
- **1281 passing tests**: `cargo test --lib` — 0 failures
...
cargo test --lib         # Run library tests (1281 passing)
...
| Test coverage | 1281 passing, 0 failed, 1 ignored (`cargo test --lib`, evidence: atlas/TEST_COUNTS.json) |
