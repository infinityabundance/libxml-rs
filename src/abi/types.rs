...
pub const XML_ERR_MISPLACED_XML_PI: c_int = 64;
pub const XML_ERR_XML_DECL_AT_EOF: c_int = 65;
pub const XML_ERR_XML_DECL_IN_PROLOG: c_int = 66;
pub const XML_ERR_XML_DECL_IN_EPILOG: c_int = 67;
pub const XML_ERR_XML_DECL_IN_DTD: c_int = 68;
pub const XML_ERR_NOT_WELL_BALANCED: c_int = 69;
pub const XML_ERR_EXTRA_CONTENT: c_int = 70;
pub const XML_ERR_INVALID_ENCODING: c_int = 71;
pub const XML_ERR_ENTITY_CHAR_ERROR: c_int = 72;
pub const XML_ERR_ENTITY_PE_INTERNAL: c_int = 73;
pub const XML_ERR_ENTITY_LOOP: c_int = 74;
pub const XML_ERR_ENTITY_BOUNDARY: c_int = 75;
pub const XML_ERR_INVALID_URI: c_int = 76;
pub const XML_ERR_URI_FRAGMENT: c_int = 77;
pub const XML_WAR_CATALOG_PI: c_int = 78;
pub const XML_ERR_NO_DTD: c_int = 79;
pub const XML_ERR_CONDSEC_INVALID: c_int = 80;
pub const XML_ERR_CONDSEC_INVALID_KEYWORD: c_int = 81;
pub const XML_ERR_INVALID_DECIMAL: c_int = 82;
pub const XML_ERR_INVALID_HEXIDECIMAL: c_int = 83;
pub const XML_ERR_INVALID_UNICODE: c_int = 84;
pub const XML_ERR_INVALID_NMTOKEN: c_int = 85;
pub const XML_ERR_INVALID_NAME: c_int = 86;
pub const XML_ERR_NAME_TOO_LONG: c_int = 87;
pub const XML_ERR_INVALID_ENUM: c_int = 88;
pub const XML_ERR_SPACE_REQUIRED: c_int = 89;
pub const XML_ERR_NAME_REQUIRED: c_int = 90;
pub const XML_ERR_NMTOKEN_REQUIRED: c_int = 91;
pub const XML_ERR_ATTRIBUTE_NOT_RESOLVED: c_int = 92;
pub const XML_ERR_LT_REQUIRED: c_int = 93;
pub const XML_ERR_GT_REQUIRED: c_int = 94;
pub const XML_ERR_TAG_NAME_MISMATCH: c_int = 95;
