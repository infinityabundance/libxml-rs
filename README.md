...
- crates.io: [`libxml-rs`](https://crates.io/crates/libxml-rs) `0.1.0-alpha.48`
...
- **1291 passing tests**: `cargo test --lib` — 0 failures
...
cargo test --lib         # Run library tests (1291 passing)
...
| Test coverage | 1291 passing, 0 failed, 1 ignored (`cargo test --lib`, evidence: atlas/TEST_COUNTS.json) |
