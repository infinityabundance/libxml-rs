...
Latest gates: `cargo test --lib` 1325 passed / 0 failed (3 ignored); PHP six-extension
...
- **1325 passing tests**: `cargo test --lib` — 0 failures
...
cargo test --lib         # Run library tests (1325 passing)
...
| Test coverage | 1325 passing, 0 failed, 3 ignored (`cargo test --lib`, evidence: atlas/TEST_COUNTS.json) |
